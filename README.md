Os desafios a seguir são para o treino e fixação de conhecimentos da linguagem Python, seus frameworks e bibliotecas. Com progressão de dificuldade.

==================================================================================================================================================================

Desafios Básicos (Nível 1-20)
1. Calculadora Simples: Crie uma calculadora simples que pode realizar operações básicas como adição, subtração, multiplicação e divisão.
2. Contador de Palavras: Escreva um programa que conte o número de palavras em um texto inserido pelo usuário.
3. Gerador de Senhas: Desenvolva um gerador de senhas que crie senhas aleatórias com um determinado comprimento.
4. Conversor de Temperatura: Crie um conversor de temperatura que converta entre Celsius, Fahrenheit e Kelvin.
5. To-Do List: Construa um aplicativo de lista de tarefas simples usando OOP para representar as tarefas.
...
8. Jogo da Forca: Implemente o clássico jogo da forca em que o jogador deve adivinhar uma palavra oculta.
...
17. Simulador de Dados: Crie um simulador de lançamento de dados que simule o lançamento de um ou mais dados.
...
71. Plataforma de Edição de Vídeo: Construa uma plataforma online que permita aos usuários editar vídeos, aplicar efeitos e compartilhar suas criações.
...
Plataforma de Gestão de Projetos de Software: Construa uma plataforma que facilite o desenvolvimento e o gerenciamento de projetos de software, incluindo controle de versões, rastreamento de problemas e colaboração de equipe.
100. Sistema de Monitoramento de Desastres Naturais: Crie um sistema que monitore e alerte sobre desastres naturais, como terremotos, furacões e incêndios florestais, fornecendo informações em tempo real e medidas de segurança.
